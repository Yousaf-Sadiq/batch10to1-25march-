...
<form class=" p-5 m-5 rounded" style="background-color: black;" action="<?php echo update_submit ?>" method="POST">
...
<input type="hidden" name="_token" value="<?php echo base64_encode($user_id) ?>">
 ...
 <input type="hidden" readonly  value="<?php echo $row["email"] ?>" name="email" class="form-control" id="exampleInputEmail1"
